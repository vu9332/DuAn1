...
public class Player_Abilities : MonoBehaviour
{
    ...
    public static void skill1AbilityCoolDown() => Skill1AbilityCoolDown?.Invoke();



    public static void skill2AbilityCoolDown() => Skill2AbilityCoolDown?.Invoke();



    public static void skill3AbilityCoolDown() => Skill3AbilityCoolDown?.Invoke();



    public static void dashAbilityCoolDown() => DashAbilityCoolDown?.Invoke();
