...
using UnityEngine;
internal static class AnimationString
{
    ...
    internal static string IsNormalAttack = "Attack";
    internal static string IsAirAttack = "AttackAir";
  //  internal static string IsComboAttack = "AttackCombo";
   ...
   // internal static string IsLedgeClimb = "IsLedgeClimb";
    ...
    public static string Hurt = "TakeDamag";
}
